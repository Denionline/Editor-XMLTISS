  ...
  switch (action.type) {
          ...
          objectXml: {
            ...
            ["ans:mensagemTISS"]: {
              ...
              ["ans:prestadorParaOperadora"]: {
                ...newArquive.objectXml["ans:mensagemTISS"]["ans:prestadorParaOperadora"],
                ["ans:loteGuias"]: {
                  ...newArquive.objectXml["ans:mensagemTISS"]["ans:prestadorParaOperadora"]["ans:loteGuias"],
                  ["ans:guiasTISS"]: {
                    ...newArquive.objectXml["ans:mensagemTISS"]["ans:prestadorParaOperadora"]["ans:loteGuias"]["ans:guiasTISS"],
    ...
    case ActionTypes.UPDATE_GUIDE_DETAILS: {
      ...
      const idxArquive = state.findIndex(
        (arquive) => arquive.ID === action.payload.idxGuide
      );
